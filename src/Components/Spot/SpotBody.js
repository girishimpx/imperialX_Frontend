          ...
          <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
            <div className="top-part-all-page basic-page-top-part">
              ...
              <div className="top-col-4 comon-flex-top-bot-style">
                ...
                <span>{`${btc?.idxPx ? `${Number(btc?.idxPx).toFixed(5).toLocaleString()}` : "0"
                  }`}</span>
              </div>
            ...
            <Grid container spacing={0} sx={{maxHeight:"100vh"}} className="spot-body-container">

              <Grid item xs={12} sm={12} md={12} lg={2} xl={2} id="marketTop">
                <h6 className="market-advance">Markets</h6>
          ...
          <Grid container spacing={0}>
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
              ...
              <Item className={classes.dashboarbodycls}>
                <OpenOrderTab selected={selected} selectedPairs={pair} />
              </Item>
            </Grid>
</Grid>
