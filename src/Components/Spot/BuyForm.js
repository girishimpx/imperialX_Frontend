  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <TabPanel value={value} index={0}>
        <BuyFormInner selected={selected} pair={pair} index={"limit"}/>
      </TabPanel>
      <TabPanel value={value} index={1}>
        <BuyForminnerMarket selected={selected} pair={pair} index={"market"} market={market} />
      </TabPanel>
      <TabPanel value={value} index={2}>
        <BuyForminnerStop selected={selected} pair={pair} index={"stop"} />
      </TabPanel>
    </Box>
  );
}