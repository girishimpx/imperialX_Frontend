...
const Sellformtab = ({ selected, pair,index ,lab }) => {
  ...
  <TabPanel value={value} index={0}>
    <SellFormInner selected={selected} pair={pair} index={'cross'} ordertype={index} labe={lab} />
  </TabPanel>
  <TabPanel value={value} index={1}>
    <SellFormInner selected={selected} pair={pair} index={'isolated'} ordertype={index} labe={lab}/>
  </TabPanel>
  </>
  )
}
