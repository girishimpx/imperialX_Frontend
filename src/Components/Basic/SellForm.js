...
import Sellformtabstop from './sellformtabstop';
...
export default function SellForm({ selected, pair ,la,market}) {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <TabPanel value={value} index={0}>
        <Sellformtab selected={selected} pair={pair} index={"limit"} lab={la} />
      </TabPanel>
      <TabPanel value={value} index={1}>
       <Sellformtabmarket selected={selected} pair={pair} index={"market"} lab={la} market={market}/>
      </TabPanel>
      <TabPanel value={value} index={2}>
       <Sellformtabstop selected={selected} pair={pair} index={"stop"} lab={la} />
      </TabPanel>
    </Box> 
  );
}  