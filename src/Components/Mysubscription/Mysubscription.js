...
import Mysubscriptionbody from './Mysubscriptionbody';
...
const Mysubscribtion = ({sideBarShow,setSideBarShow, openSideBar, setOpenSideBar}) => {
  ...
  return (
    ...
    <Item className={classes.headercls}>
      <Header sideBarShow={sideBarShow}
                  setSideBarShow={setSideBarShow} openSideBar={openSideBar }
                  setOpenSideBar={setOpenSideBar}/>
      <Mysubscriptionbody sideBarShow={sideBarShow}
                  setSideBarShow={setSideBarShow} openSideBar={openSideBar }
                  setOpenSideBar={setOpenSideBar}/>
    </Item>
    </Grid>
