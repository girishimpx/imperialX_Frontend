...
const [list,setList]= React.useState(['Limit','Market','Stop'])
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <Buyformtab selected={selected} pair={pair} index={"limit"} market={market} reload={reload} cat={cat}/>
      </TabPanel>
      <TabPanel value={value} index={1}>
      <Buyformtabmarket selected={selected} pair={pair} index={"market"} market={market} reload={reload} cat={cat}/>
      </TabPanel>
      {/* <TabPanel value={value} index={2}> 
      <Buyformtabstop selected={selected} pair={pair} index={"stop"} market={market} reload={reload} cat={cat}/>
      </TabPanel> */}
    </Box>
  );
}