      ...
      <div className="Form-Inner-box form-Inner-box-style future-form-block-right-part">
        ...
        <Stack direction="column" spacing={10}>
          <div className="price-limit-spot">
            {/* <label className="form-label-style">Priceeee ({pair ? pair.split('-')[1] : "USD"})</label> */}
            ...
            <div className="">
              <FormControl sx={{ m: 1, width: "25ch" }} variant="outlined">
                <OutlinedInput
                  ...
                  placeholder={`Min ${pair ? pair.split(0, -cat?.length) : "USD"}`}
                  // endAdornment={
        ...
        // </FormGroup> */}
                ...
                {pair &&
                  ...
                  balance.find((item) => item.symbol === pair.split("-")[0]) && (
                    <div>
                      {/* {balance.find((item) => item.symbol === pair.split("-")[0])
                          .balance}{" "} */}
                      0.000000 {pair.slice(0, -cat?.length)}
                    </div>
                  )}
              </div>
            </div>
          ...
          <Button className="Buy-SOL" variant="contained" onClick={buytrade} disabled={!load}>
            ...
            Buy {selected?.pair ? selected?.pair.split(0, -4) : ""}
