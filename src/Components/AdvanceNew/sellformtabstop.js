...
const Sellformtabstop = ({ selected, pair,index, market }) => {
  ...
  <TabPanel value={value} index={0}>
    <SellFormInnerstop selected={selected} pair={pair} index={'cross'} ordertype={index} market={market} />
  </TabPanel>
  <TabPanel value={value} index={1}>
    <SellFormInnerstop selected={selected} pair={pair} index={'isolated'} ordertype={index} market={market} />
  </TabPanel>
