...
const Sellformtab = ({ selected, pair,index }) => {
  ...
  <SellFormInner selected={selected} pair={pair} index={'cross'} ordertype={index} />
  </TabPanel>
  <TabPanel value={value} index={1}>
    <SellFormInner selected={selected} pair={pair} index={'isolated'} ordertype={index}/>
  </TabPanel>
