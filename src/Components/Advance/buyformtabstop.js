...
const Buyformtabstop = ({ selected, pair,index }) => {
  ...
  <TabPanel value={value} index={0}>
    <BuyFormInnerstop selected={selected} pair={pair} index={'cross'} ordertype={index}/>
  </TabPanel>
  <TabPanel value={value} index={1}>
    <BuyFormInnerstop selected={selected} pair={pair} index={'isolated'} ordertype={index}/>
  </TabPanel>
