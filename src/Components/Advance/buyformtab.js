...
const Buyformtab = ({ selected, pair,index ,ordertype }) => {
  ...
  <TabPanel value={value} index={0}>
    <BuyFormInner selected={selected} pair={pair} index={'cross'} ordertype={index} />
  </TabPanel>
  <TabPanel value={value} index={1}>
    <BuyFormInner selected={selected} pair={pair} index={'isolated'} ordertype={index}/>
  </TabPanel>
