        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="right"><div id={row.lossgainpercentage < 0 ? 'red-low-color':'green-high-color'} className='lossgainfactor'>{row.lossgainfactor}</div></TableCell>
              <TableCell align="right"><span id={row.lossgainpercentage < 0 ? 'red-low':'green-high'} className='lossgainpercentage'>{row.lossgainpercentage}%</span></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
