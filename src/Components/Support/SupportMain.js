...
const SupportMain = ({ setSideBarShow, sideBarShow, openSideBar, setOpenSideBar }) => {

  const classes = useStyles();

  const handleEmailClick = () => {
    const email = 'support@imperialx.exchange';
    const subject = encodeURIComponent('Imperial Support');
                  ...
                  <Grid item xs={12} sm={12} md={12} lg={4} xl={4}>
                    <Item className={classes.transbg}>
                      <div className="common-size-block"  >
                        ...
                        <span style={{cursor : 'pointer'}} onClick={ handleEmailClick } > Click here to Mail Us</span>
                        {/* <span>support@imperialx.exchange</span> */}
                      </div>
                    </Item>
                  </Grid>
